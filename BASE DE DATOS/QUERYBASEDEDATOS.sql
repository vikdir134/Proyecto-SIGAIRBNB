...
(
    ...
    pais                    NVARCHAR(100) NOT NULL DEFAULT 'Per�',
...
(
    ...
    -- Datos b�sicos para vetting simplificado del inquilino
...
-- Cat�logo flexible de caracter�sticas
...
-- Caracter�sticas asignadas por inmueble
...
-- Fotos del inmueble/publicaci�n
...
-- Cat�logo de conceptos de cobro
...
-- Configuraci�n de conceptos por inmueble
...
-- Hist�rico de tarifas/renta por inmueble
...
-- Categor�as de movimientos: gasto o ingreso
